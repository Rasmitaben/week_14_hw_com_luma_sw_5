...
public class WomenTest extends BaseTest {
    ...
    public void verifyTheSortByProductNameFilter() throws InterruptedException {
        ...
        org.testng.Assert.assertEquals(womenTestPage.returnActualProductNameArrayList(), expectedList, "Error message: Products are not displayed in alphabetical order");
    }
